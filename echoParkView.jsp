...
<% 
	...
	resultSet = statement.executeQuery("SELECT * FROM EchoPark");
	resultSet1 = statement1.executeQuery("SELECT count(*) FROM EchoPark");
	resultSet2 = statement2.executeQuery("SELECT * FROM EchoPark WHERE id=1");
	resultSet3 = statement3.executeQuery("SELECT * FROM EchoPark");
